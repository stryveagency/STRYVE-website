    ...
    >
      ...
      <div className="relative z-1 mx-auto flex w-full max-w-[1560px] justify-center px-6 py-16 sm:px-10 sm:py-20 lg:justify-end lg:px-20 lg:py-24">
        <Reveal anim="pop" className="max-w-[560px] text-center lg:text-right">
          <h2
            className="m-0 font-display text-[36px] leading-[1.1] font-black tracking-[0.01em] text-white uppercase sm:text-[44px] lg:text-[56px]"
            style={{ textShadow: '0 0 20px rgba(0, 255, 209,0.4)' }}
          >
            PRONTO PARA CRESCER?
          </h2>
          <p className="mx-auto mt-5 max-w-[500px] font-body text-lg leading-[1.6] text-gray-light text-pretty sm:text-xl lg:mx-0 lg:text-[22px]">
          ...
          <div className="mt-10 flex justify-center lg:justify-end">
            <a
              ...
              target="_blank"
              rel="noopener"
              className="inline-flex w-max flex-shrink-0 items-center justify-center gap-3 rounded-md bg-mint px-[50px] py-5 font-body text-lg font-extrabold tracking-[0.12em] text-black uppercase no-underline shadow-[0_0_40px_rgba(0, 255, 209,0.6)] [animation:stryve-btn-pulse_2.8s_ease-in-out_infinite] transition-all duration-300 ease-out hover:scale-[1.08] hover:bg-mint hover:shadow-[0_0_60px_rgba(0, 255, 209,0.85)]"
            >
